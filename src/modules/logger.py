...
def get_logger():
    ...
    logformat = current_config.get('config.logs.format') or "console"
...
loglevelconf = current_config.get('config.logs.log_level') or "INFO"
logger.setLevel(loglevelconf.upper())
